...
class TestHeaders(unittest.TestCase):
    def test_ipv4_header(self):
        ...
        correct_value = b'\x45\x00\x04\x21\x00\x00\x00\x00\x40\x11\x00\x00\x80\xBB\x52\xFE\x80\xAA\x33\x3F'
        correct_value = binascii.hexlify(correct_value)
    ...
    def test_tcp_header(self):
        ...
        correct_value = b'\x04\x63\x07\xE9\x00\x0D\x5F\xFB\x00\x06\xE8\xF2\x50\x12\x00\x40\x00\x00\x00\x00'
        correct_value = binascii.hexlify(correct_value)
